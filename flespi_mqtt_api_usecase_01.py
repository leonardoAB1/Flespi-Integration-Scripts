...
Date: 2024-02-02
Script Name: flespi_mqtt_api_usecase_01.py

MQTT Client Script with Flespi Integration to get Scooter Location
...
def on_connect(client, flags, rc, properties):
    print(f'connected, subscribing to "flespi/state/gw/devices/{device_id}/telemetry/position" topic...')
    client.subscribe(f'flespi/state/gw/devices/{device_id}/telemetry/position', qos=1)
