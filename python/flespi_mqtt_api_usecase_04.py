...
Date: 2024-02-07
Script Name: flespi_mqtt_api_usecase_04.py

MQTT Client Script with Flespi Integration to get Scooter's Location and Battery
...
device_id = 5544049
topic=f'flespi/state/gw/devices/{device_id}/telemetry/position,battery.level'
